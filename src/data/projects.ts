...
const projects: Project[] = [
  {
    ...
    shortDesc:
      "Built MFE foundation with React, Webpack & Single SPA enabling independent deployments for 10+ teams.",
  ...
  },
  {
    ...
    shortDesc:
      "Built centralized identity & RBAC governance platform enabling 10+ microservices and micro frontends.",
  ...
  },
  {
    ...
    shortDesc:
      "Designed SNS→SQS event-driven ingestion pipeline achieving 99.9%+ reliability with zero event loss.",
  ...
  },
  {
    ...
    shortDesc:
      "Automated daily data merge, validation & SFTP delivery reducing processing time from hours to minutes.",
  ...
  },
  {
    ...
    shortDesc:
      "Built hospital operations system handling patient registration, OPD, IPD, billing, nursing & scheduling.",
  ...
  },
  {
    ...
    shortDesc:
      "Internal project management tool adopted by 10+ teams, replacing licensed tools.",
  ...
  },
  {
    ...
    shortDesc:
      "Full-stack portfolio with featured project showcase, dynamic filtering, search, and responsive design.",
